...
exports.resizeTourImages = catchErrorAsync(async (req, res, next) => {
...
exports.getToursWithin = catchErrorAsync(async (req, res, next) => {
...
exports.getDistances = catchErrorAsync(async (req, res, next) => {
